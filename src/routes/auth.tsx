    ...
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <div className="font-display text-2xl font-bold">ForgeFit</div>
            <div className="text-xs text-muted-foreground">Trainer Dashboard</div>
          </div>
        </div>
        ...
        <div className="glass w-full rounded-2xl border border-border/60 p-7 shadow-2xl">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin"
              ...
              : "Start tracking clients, attendance, and incentives."}
          </p>
